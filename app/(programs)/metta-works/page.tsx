...
const MettaWorks = () => {
  return (
    <div className="bg-gradient-calm min-h-screen">
      {/* Hero */}
      <section className="relative overflow-hidden bg-black/20 bg-[url('/metta-works.jpg')] bg-size-[200%] bg-position-[center_top_65%] text-white bg-blend-overlay md:bg-cover md:bg-position-[center_top_55%]">
